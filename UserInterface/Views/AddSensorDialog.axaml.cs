...
namespace UserInterface.Views
{
	public class AddSensorDialog : Window
	{
		...
		public AddSensorDialog() {
			...
			ComboBox.Items = Enum.GetValues(typeof(AvailableSensors)).Cast<AvailableSensors>()
				.OrderBy(v => v.ToString());
			ComboBox.SelectedIndex = 0;

			// register IPC clients
			var serviceProvider = new ServiceCollection()
				.AddNamedPipeIpcClient<IServiceContractInterfaces>("addsensor", "pipeinternal")
		...
		private void FillDefaultValues() {
			...
			switch (ComboBox.SelectedItem) {
				case AvailableSensors.UserNotificationStateSensor:
					item.Description =
						"This sensor watches the UserNotificationState. This is normally used in applications to determine if it is appropriate to send a notification but we can use it to expose this state. \n ";
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#usernotificationstate";
				...
				case AvailableSensors.DummySensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#dummysensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
				...
				case AvailableSensors.CPULoadSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#cpuloadsensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.CurrentClockSpeedSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#currentclockspeedsensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
				...
				case AvailableSensors.WMIQuerySensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipperhass-workstation-service/blob/master/documentation/WMIQuery.md#wmiquerysensor";
				...
				case AvailableSensors.MemoryUsageSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#memoryusagesensorsensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 10;
					break;
				...
				case AvailableSensors.ActiveWindowSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#activewindowsensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.WebcamActiveSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#webcamactivesensor";
					item.ShowQueryInput = false;
					item.UpdateInterval = 10;
					break;
				...
				case AvailableSensors.WebcamProcessSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#webcamprocesssensor";
					item.ShowQueryInput = false;
					item.UpdateInterval = 10;
					break;
				...
				case AvailableSensors.MicrophoneActiveSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#microphoneactivesensor";
					item.ShowQueryInput = false;
					item.UpdateInterval = 10;
					break;
				...
				case AvailableSensors.MicrophoneProcessSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#microphoneprocesssensor";
					item.ShowQueryInput = false;
					item.UpdateInterval = 10;
					break;
				...
				case AvailableSensors.NamedWindowSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#namedwindowsensor";
					item.ShowQueryInput = false;
				...
				case AvailableSensors.LastActiveSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#lastactivesensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.LastBootSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#lastbootsensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.SessionStateSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#sessionstatesensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.CurrentVolumeSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#currentvolumesensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.MasterVolumeSensor:
					item.Description =
						"This sensor returns the master volume of the currently selected default audio device as a percentage value.";
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#mastervolumesensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
				...
				case AvailableSensors.GPUTemperatureSensor:
					...
					item.MoreInfoLink =
						"https://github.com/sleevezipper/hass-workstation-service/blob/master/documentation/Sensors.md#gputemperaturesensor";
					item.ShowQueryInput = false;
					item.ShowWindowNameInput = false;
					item.UpdateInterval = 5;
					break;
