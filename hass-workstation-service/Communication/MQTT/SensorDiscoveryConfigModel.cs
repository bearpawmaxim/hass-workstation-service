...
namespace hass_workstation_service.Communication
{
	...
	{
        /// <summary>
        ///     (Optional) Information about the device this sensor is a part of to tie it into the device registry. Only works
		...
		[JsonPropertyName("name")] public string CompiledName => GetName();
        ...
        public string GetName() {
			if (string.IsNullOrWhiteSpace(NamePrefix)) return Name;
	...
	public class SensorDiscoveryConfigModel : DiscoveryConfigModel
	{
        ...
        /// <summary>
        ///     (Optional) The type/class of the sensor to set the icon in the frontend. See
        ///     https://www.home-assistant.io/integrations/sensor/#device-class for options.
        /// </summary>
        /// <value></value>
        public string Device_class { get; set; }

        /// <summary>
        ///     (Optional) Defines the number of seconds after the sensor’s state expires, if it’s not updated. After expiry, the
        ///     sensor’s state becomes unavailable. Defaults to 0 in hass.
        /// </summary>
        /// <value></value>
        public int? Expire_after { get; set; }

        /// <summary>
        ///     Sends update events even if the value hasn’t changed. Useful if you want to have meaningful value graphs in
        ///     history.
        /// </summary>
        /// <value></value>
        ...
        /// <summary>
        ///     (Optional) An ID that uniquely identifies this sensor. If two sensors have the same unique ID, Home Assistant will
        ///     raise an exception.
        /// </summary>
        /// <value></value>
	...
	{
        /// <summary>
        ///     (Optional) A list of connections of the device to the outside world as a list of tuples [connection_type,
        ///     connection_identifier]. For example the MAC address of a network interface: "connections": [["mac",
        ///     "02:5b:26:a8:dc:12"]].
        /// </summary>
        /// <value></value>
        ...
        /// <summary>
        ///     (Optional) Identifier of a device that routes messages between this device and Home Assistant. Examples of such
